...
if __name__=="__main__":
    ...
    line_c, = plt.plot(*zip(*data_a), c='red')
    line_d, = plt.plot(*zip(*data_b), c='magenta')
    line_e, = plt.plot(*zip(*data_a), c='cyan')
    ani = animation.FuncAnimation(fig, animate, interval=10)
    plt.legend(["ch1", "ch2", "ch3", "ch4", "ch5"], loc ="upper left")
    plt.xlabel("Time (s)")
